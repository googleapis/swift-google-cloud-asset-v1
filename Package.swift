...
let package = Package(
  ...
  dependencies: [
    ...
    localOrRemotePackage(
      url: "https://github.com/googleapis/swift-google-cloud-osconfig-v1",
      path: "generated/swift-google-cloud-osconfig-v1",
      from: "0.3.0"
    ),
    localOrRemotePackage(
      url: "https://github.com/googleapis/swift-google-cloud-orgpolicy-v1",
      path: "generated/swift-google-cloud-orgpolicy-v1",
      from: "0.3.0"
    ),
    localOrRemotePackage(
    ...
    localOrRemotePackage(
      ...
      path: "generated/swift-google-identity-accesscontextmanager-v1",
      from: "0.3.0"
    ),
    localOrRemotePackage(
  ...
  targets: [
    .target(
      ...
      dependencies: [
        ...
        .product(name: "GoogleCloudOSConfigV1", package: "swift-google-cloud-osconfig-v1"),
        .product(name: "GoogleCloudOrgPolicyV1", package: "swift-google-cloud-orgpolicy-v1"),
        ...
        .product(
          ...
          package: "swift-google-identity-accesscontextmanager-v1"),
