  ...
  Sendable
{
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let evaluationValue = CodingKeys(stringValue: "evaluationValue")
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent(
      ConditionEvaluation.EvaluationValue.self, forKey: .evaluationValue)
    {
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.evaluationValue, forKey: .evaluationValue)
