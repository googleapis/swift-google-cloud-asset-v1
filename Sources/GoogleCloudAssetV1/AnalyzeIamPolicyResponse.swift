...
public struct AnalyzeIamPolicyResponse: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  public struct IamPolicyAnalysis: Codable, Equatable, GoogleWKT._AnyPackable,
    Sendable
  {
    /// The analysis query.
