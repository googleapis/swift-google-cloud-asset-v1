...
public struct SearchAllResourcesResponse: Codable, Equatable, GoogleCloudWKT._AnyPackable,
  ...
  Sendable
{
  ...
  /// Initialize a new instance of `SearchAllResourcesResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = SearchAllResourcesResponse().with { $0.results = ... }
  /// ```
  ...
  public init(from decoder: Decoder) throws {
    ...
    if let value = try container.decodeIfPresent([ResourceSearchResult].self, forKey: .results) {
      self.results = value
    }
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.asset.v1.SearchAllResourcesResponse"
  }
