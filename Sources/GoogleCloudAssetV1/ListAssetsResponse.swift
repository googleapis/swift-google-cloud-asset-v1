...
/// ListAssets response.
public struct ListAssetsResponse: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  /// Initialize a new instance of `ListAssetsResponse`.
  public init() {}
  ...
  ///
  /// ```
  /// let value = ListAssetsResponse().with { $0.readTime = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.asset.v1.ListAssetsResponse"
  }
...
extension ListAssetsResponse: GoogleGax._PaginatedResponse {
  public func _getPaginatedItems() -> [Asset] {
    return self.assets
  }
