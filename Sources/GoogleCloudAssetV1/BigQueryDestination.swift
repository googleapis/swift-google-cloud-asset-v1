  ...
  Sendable
{
  ...
  public var partitionSpec: PartitionSpec? = nil
  ...
  public var separateTablesPerAssetType: Swift.Bool = Swift.Bool()
  ...
  private struct CodingKeys: CodingKey {
    ...
    static let partitionSpec = CodingKeys(stringValue: "partitionSpec")
    static let separateTablesPerAssetType = CodingKeys(stringValue: "separateTablesPerAssetType")
  ...
  public init(from decoder: Decoder) throws {
    ...
    self.partitionSpec = try container.decodeIfPresent(PartitionSpec.self, forKey: .partitionSpec)
    if let value = try container.decodeIfPresent(
      Swift.Bool.self, forKey: .separateTablesPerAssetType)
    {
      self.separateTablesPerAssetType = value
    }
  ...
  public func encode(to encoder: Encoder) throws {
    ...
    try container.encode(self.separateTablesPerAssetType, forKey: .separateTablesPerAssetType)
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.asset.v1.BigQueryDestination"
  }
