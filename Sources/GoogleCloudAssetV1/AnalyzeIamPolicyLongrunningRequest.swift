...
public struct AnalyzeIamPolicyLongrunningRequest: Codable, Equatable, GoogleWKT._AnyPackable,
  Sendable
{
  ...
  ///
  /// ```
  /// let value = AnalyzeIamPolicyLongrunningRequest().with { $0.analysisQuery = ... }
  /// ```
  ...
  public static var _anyTypeUrl: Swift.String {
    return "type.googleapis.com/google.cloud.asset.v1.AnalyzeIamPolicyLongrunningRequest"
  }
